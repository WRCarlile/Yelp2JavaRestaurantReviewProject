...
//      Restaurant secondRestaurant = new Restaurant("Burger King", myCuisine.getId());
...
//     Cuisine myCuisine = new Cuisine("Home");
//     myCuisine.save();
//     Restaurant myRestaurant = new Restaurant("Clean", myCuisine.getId());
//     myRestaurant.save();
//     String cuisinePath = String.format("http://localhost:4567/cuisines/%d", myCuisine.getId());
//     goTo(cuisinePath);
